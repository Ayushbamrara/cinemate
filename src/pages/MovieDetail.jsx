...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    ...
    const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=15c75efde3e2204f25ed29917cfa6b91`);
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          { movie.genres ? (
            ...
            <div class="flex items-center">
              ...
              <p class="ms-2   text-gray-900 dark:text-white">{movie.vote_average}</p>
              <span class="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
              <span class=" text-gray-900  dark:text-white">{movie.vote_count}</span>
            </div>
            <p className="my-4">
